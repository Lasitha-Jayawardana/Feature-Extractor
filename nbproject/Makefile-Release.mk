...
${OBJECTDIR}/Conversation.o: Conversation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Conversation.o Conversation.cpp

${OBJECTDIR}/ConversationFeatures.o: ConversationFeatures.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConversationFeatures.o ConversationFeatures.cpp

${OBJECTDIR}/ConversationReconstructor.o: ConversationReconstructor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConversationReconstructor.o ConversationReconstructor.cpp

${OBJECTDIR}/FeatureUpdaterCount.o: FeatureUpdaterCount.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FeatureUpdaterCount.o FeatureUpdaterCount.cpp

${OBJECTDIR}/FeatureUpdaterTime.o: FeatureUpdaterTime.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FeatureUpdaterTime.o FeatureUpdaterTime.cpp

${OBJECTDIR}/FiveTuple.o: FiveTuple.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FiveTuple.o FiveTuple.cpp

${OBJECTDIR}/IcmpConversation.o: IcmpConversation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IcmpConversation.o IcmpConversation.cpp

${OBJECTDIR}/IntervalKeeper.o: IntervalKeeper.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IntervalKeeper.o IntervalKeeper.cpp

${OBJECTDIR}/IpDatagram.o: IpDatagram.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IpDatagram.o IpDatagram.cpp

${OBJECTDIR}/IpFragment.o: IpFragment.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IpFragment.o IpFragment.cpp

${OBJECTDIR}/IpReassembler.o: IpReassembler.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IpReassembler.o IpReassembler.cpp

${OBJECTDIR}/IpReassemblyBuffer.o: IpReassemblyBuffer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IpReassemblyBuffer.o IpReassemblyBuffer.cpp

${OBJECTDIR}/IpReassemblyBufferHoleList.o: IpReassemblyBufferHoleList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IpReassemblyBufferHoleList.o IpReassemblyBufferHoleList.cpp
...
${OBJECTDIR}/ReferenceCounter.o: ReferenceCounter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReferenceCounter.o ReferenceCounter.cpp

${OBJECTDIR}/Sniffer.o: Sniffer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sniffer.o Sniffer.cpp

${OBJECTDIR}/StatsEngine.o: StatsEngine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsEngine.o StatsEngine.cpp

${OBJECTDIR}/StatsPerHost.o: StatsPerHost.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsPerHost.o StatsPerHost.cpp

${OBJECTDIR}/StatsPerService.o: StatsPerService.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsPerService.o StatsPerService.cpp

${OBJECTDIR}/StatsPerServiceWithSrcPort.o: StatsPerServiceWithSrcPort.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsPerServiceWithSrcPort.o StatsPerServiceWithSrcPort.cpp

${OBJECTDIR}/StatsWindow.o: StatsWindow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsWindow.o StatsWindow.cpp

${OBJECTDIR}/StatsWindowCount.o: StatsWindowCount.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsWindowCount.o StatsWindowCount.cpp

${OBJECTDIR}/StatsWindowTime.o: StatsWindowTime.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsWindowTime.o StatsWindowTime.cpp
...
${OBJECTDIR}/UdpConversation.o: UdpConversation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UdpConversation.o UdpConversation.cpp
...
${OBJECTDIR}/net.o: net.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/net.o net.cpp
